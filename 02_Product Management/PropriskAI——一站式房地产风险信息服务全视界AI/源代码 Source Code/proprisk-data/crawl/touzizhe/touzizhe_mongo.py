...
class YanbaoInfoSpider:
    ...
    def save_results_to_mongodb(self):
        ...
        db = client['touzizhe']
        collection = db['dayuecheng']

        for result in self.results:
            collection.insert_one(result)  # 将结果插入到MongoDB集合中

    def save_results_to_file(self, filename="touzizhe_results_final.txt"):
...
if __name__ == "__main__":
    ...
    with open("dayuecheng_links", "r", encoding="utf-8") as file:
